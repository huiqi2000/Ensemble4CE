...
project_path = '/home/data02/zjc/abaw/manet/'
data_path = '/home/data02/zjc/abaw/dataset/RAFDBCE7'
checkpoint_path = ''
...
def main():
    ...
    if not args.scratch:
        checkpoint = torch.load(project_path + '[02-08]-[21-19]-model_best-acc88.33.pth', map_location='cpu')['state_dict']
        checkpoint = torch.load('/home/data02/zjc/abaw/manet/checkpoint/[03-18]-[04-04]-model_best.pth')['state_dict']
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            trues.extend(target.cpu().detach().numpy())
            preds.extend(output.cpu().argmax(dim=-1).detach().numpy())
